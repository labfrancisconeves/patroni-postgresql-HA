...
- [1\. Networking pre-requisites](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [PostgreSQL Replication and HA - Firewall and User Requirements](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
    - [Firewall Ports](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
    - [Required PostgreSQL Users](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
- [2\. Environment](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
- [3\. ETCD - Cluster](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Step 1. Install etcd on each node](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Step 2. Create user and folder for the service](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Step 3. Create file /etc/systemd/system/etcd.service](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Start and enable service on each node](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
- [4\. Postgresql 14](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Installation](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
- [5\. Patroni](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Dependency installation](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Create the service file (/etc/systemd/system/patroni.service)](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Create file /etc/patroni.yml](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Start and enable the service on the 2 nodes](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
- [6\. Keepalived](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Installation](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Create file /etc/keepalived/keepalived.conf](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Create the IP bounce script /usr/local/bin/check_patroni.sh](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Start and enable the service on the 2 nodes:](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
- [7\. Useful commands](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Check patroni cluster status](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
  - [Check if the VIP is correctly attached](#BDU-PostgreSQLHASetupwithPatroni/etcd/k)
...
Ensure the following ports are open between the nodes (bdu-cgd-psql-01, 02, and 03):
...
| --- | --- | --- | --- |
| bdu-cgd-psql-01 | 10.20.20.180 | Etcd + patroni + keepalived | Oracle Linux 8.10 |
| bdu-cgd-psql-02 | 10.20.20.181 | Etcd + patroni + keepalived | Oracle Linux 8.10 |
| bdu-cgd-psql-03 | 10.20.20.182 | Etcd | Oracle Linux 8.10 |
...
Example for node 1 (bdu-cgd-psql-01):
...
&nbsp; --initial-cluster bdu-cgd-psql-01=<http://10.20.20.180:2380,bdu-cgd-psql-02=http://10.20.20.181:2380,bdu-cgd-psql-03=http://10.20.20.182:2380> \\\\
...
Example for node 2 (bdu-cgd-psql-02), replace:

- \--name bdu-cgd-psql-02
...
Example for node 3 (bdu-cgd-psql-03), replace:

- \--name bdu-cgd-psql-03
- IP 10.20.20.182
...
| bdu-cgd-psql-01 | 10.20.20.180 | Leader  | running   | 24 |           | \*               | max_wal_senders: 10->5 |

| bdu-cgd-psql-02 | 10.20.20.181 | Replica | streaming | 24 |         0 | \*               | max_wal_senders: 10->5 |
